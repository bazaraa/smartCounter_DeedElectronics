var orderMonasteryManagerTableEditable = function() {

	var handleTable = function() {

		var table = $('#orderMonasteryManager_editable_1');
									...
									.confirm({
										...
										callback : function(result) {
											...
											$
													.ajax({
														type : "POST",
														url : "/orderMonasteryManager/delete",
														async : false,
														dataType : "json",
														data : param,
														success : function(
