var restaurantTypeTableEditable = function() {
	...
	var handleTable = function() {
		...
		function editRow(oTable, nRow) {
			...
			var checked = "";			
			if(aData[3] && aData[3].indexOf && aData[3].indexOf('checked="true"') > 0)
		...
		var table = $('#restauranttype_editable_1');
		...
		var tableWrapper = $("#restauranttype_editable_1_wrapper");
