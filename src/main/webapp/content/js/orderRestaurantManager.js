var orderRestaurantManagerTableEditable = function() {

	var handleTable = function() {

		var table = $('#orderRestaurantManager_editable_1');
									...
									.confirm({
										...
										callback : function(result) {
											...
											$
													.ajax({
														type : "POST",
														url : "/orderRestaurantManager/delete",
														async : false,
														dataType : "json",
														data : param,
														success : function(
