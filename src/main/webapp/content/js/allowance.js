var allowAnce= function() {
	...
	var handleTable = function() {
		...
		var table = $('#allowance_editable_1');
		...
		var tableWrapper = $("#allowance_editable_1_wrapper");
		...
		$('#allowance-form input').keypress(function(e) {
            if (e.which == 13) {
                return false;
            }
        });
						...
						success : function(result) {
							...
							if (result.success == true) {
								...
								if(result.data.removedRegistration)
									$('#funeralAid').prop('checked',true).parent().addClass("checked");
								else
									$('#funeralAid').prop('checked',true).parent().removeClass("checked");
