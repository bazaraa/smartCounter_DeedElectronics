var carlimitTableEditable = function() {
...
var carlimitForm = function() {

	var handleCarForm = function() {
		$('#carlimit-form').validate({
			...
			messages : {
				limit : {
					required : "Нормоо тоогоор оруулна уу !"
				},
				relocateEnum :{
					required : "Нутагшуулах газараа сонгоно уу !"
				}
			},
