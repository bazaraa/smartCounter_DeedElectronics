var monasteryTableEditable = function() {
	...
	var handleTable = function() {
		...
		function saveRow(oTable, nRow) {
			...
			param.address = jqInputs[2].value;
			
			if(param.code == "" || param.name == "" || param.address == ""){
				CRSWebUtils.showAlert("danger", "warning", "Хийдийн код, хийдийн нэр эсвэл хийдийн хаягийн аль нэг нь бичигдээгүй байна . Дахин бүртгэлээ эхлэнэ үү.", 0);
				...
				$.ajax({
					...
					success : function(result) {
						if (result.success == true) {
							...
							oTable.fnUpdate(result.data.address, nRow, 3, false);
		...
		function cancelEditRow(oTable, nRow) {
			...
			oTable.fnUpdate('<a class="edit" href="">Засах</a>', nRow, 5, false);
			oTable.fnDraw();
		}

		var table = $('#monastery_editable_1');
		...
		var tableWrapper = $("#monastery_editable_1_wrapper");
