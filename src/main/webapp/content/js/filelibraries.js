var fileLibrariesTable = function() {

	var handleTable = function() {

		var table = $('#fileLibraries_editable_1');
		...
		var tableWrapper = $("#fileLibraries_editable_1_wrapper");
	...
	return {
		...
		init : function() {
			...
			$("#cmbServiceType").change(function() {
				...
				document.location.href = "/filelibraries?type=" + me.val();
			});
		}
