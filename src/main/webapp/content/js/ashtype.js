var ashTypeTableEditable = function() {
	...
	var handleTable = function() {
							...
							success : function(result) {
								if (result.success == true) {
									...
									oTable.fnUpdate(result.data.id, nRow, 0,
											false);
									oTable.fnUpdate(result.data.name, nRow, 1,
											false);
		...
		var tableWrapper = $("#ashtype_editable_1_wrapper");
